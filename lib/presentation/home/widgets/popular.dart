...
class TrendingMoviesLists extends StatefulWidget {
  const TrendingMoviesLists({
    required this.title,
    super.key,
  });
  final String title;
  ...
  @override
  State<TrendingMoviesLists> createState() => _TrendingMoviesListsState();
}

class _TrendingMoviesListsState extends State<TrendingMoviesLists> {
  late Future<PopularMovies?> tvShows;
  ApiServiceHome apiServiceHome = ApiServiceHome();

  @override
  void initState() {
    tvShows = apiServiceHome.getPopularMovies();
    super.initState();
  }
